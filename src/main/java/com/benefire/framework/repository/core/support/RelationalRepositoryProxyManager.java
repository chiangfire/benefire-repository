package com.benefire.framework.repository.core.support;
...
import com.benefire.framework.repository.domain.Page;
import com.benefire.framework.repository.domain.PageRequest;
import com.benefire.framework.repository.domain.ProperHelper;
import com.benefire.framework.repository.domain.Sort.Order;
...
import com.benefire.framework.repository.id.factory.internal.DefaultIdentifierGeneratorManager;
import com.benefire.framework.repository.query.parser.Part;
import com.benefire.framework.repository.query.parser.PartTree;
import com.benefire.framework.repository.query.parser.PartTree.Keyword;
import com.benefire.framework.repository.query.parser.PartTree.OrPart;
import com.benefire.framework.repository.util.EntityPropertyHelper;
import com.benefire.framework.repository.util.EntityPropertyHelper.EntityProperty;
import com.benefire.framework.repository.vendor.Database;
import com.benefire.framework.repository.vendor.LimitHandler;
import com.benefire.framework.repository.xml.NamedQueryCandidateComponentProvider;
import com.google.common.base.Strings;
import static com.benefire.framework.repository.util.ObjectUtil.objectToList;
import static com.benefire.framework.repository.util.ClassUtil.findCertainGenericType;
import static com.benefire.framework.repository.util.ClassUtil.findGenericReturnType;
...
public class RelationalRepositoryProxyManager implements RepositoryProxyManager{
	...
	private final IdentifierGeneratorManager generatorManager = new DefaultIdentifierGeneratorManager();
	    		...
	    		if(null != object){
					...
					for(int j=0; j < fieldSize; j++){
						...
						if(null != entityProperty.getGenerator()){
							IdGenerator generator = generatorManager.getIdentifierGenerator(entityProperty.getGenerator());
							if(null != generator){
								Serializable value = generator.generate();
